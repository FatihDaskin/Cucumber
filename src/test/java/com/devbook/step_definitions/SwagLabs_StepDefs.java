...
public class SwagLabs_StepDefs {
    ...
    public void the_user_navigates_to_swag_labs_login_page() {
        swagLabsLoginPages.loginPageSwagLabs();
    }
    @When("The user enters {string} and {string} credentails")
    public void the_user_enters_and_credentails(String username, String password) {
